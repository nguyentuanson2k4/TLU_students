...
export class LecturersController {
  ...
  @ApiOperation({ summary: 'Import danh sách giảng viên từ file Excel (Admin)' })
  ...
  updateProfile(@Req() req: any, @Body() updateProfileDto: UpdateLecturerProfileDto) {
  ...
  update(@Param('code') code: string, @Body() updateLecturerDto: UpdateLecturerDto) {
